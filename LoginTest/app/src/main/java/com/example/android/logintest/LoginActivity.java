...
import static com.example.android.logintest.R.string.username;
        ...
        bLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(success == 1)
                {
                    ...
                    Toast.makeText(LoginActivity.this,"Welcome, "+welcomeUsername+"!",Toast.LENGTH_LONG).show();
                ...
                {
                    Toast.makeText(LoginActivity.this,"No match for what you have entered. Make sure you have registered by clicking on 'Register Here'",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
