...
public class Homepage extends Activity implements TextWatcher {
    ...
    public void goToSkillsTips(View view)
    {
        Intent nextPage = new Intent(Homepage.this, SkillsTips.class);
    ...
    {
        Intent nextPage = new Intent(Homepage.this, Settings.class);
        startActivity(nextPage);
    }

    public void goToPractice(View view)
    {
        Intent nextPage = new Intent(Homepage.this, FaceTrackerActivity.class);
        startActivity(nextPage);
    }

    public void goToVideos(View view)
    {
        Intent nextPage = new Intent(Homepage.this, VideosList.class);
        startActivity(nextPage);
    }
