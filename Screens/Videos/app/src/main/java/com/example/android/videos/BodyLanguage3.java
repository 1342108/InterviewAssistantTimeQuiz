...
public class BodyLanguage3 extends AppCompatActivity {
    ImageButton iButton;
    VideoView video;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_language3);
    ...
    public void playVideo(View v)
    {
        ...
        Uri uri = Uri.parse("android.resource://com.example.android.videos/"+R.raw.body_language3); // Uniform Resource Identifier - accepts a string of chars used to identify the resource
