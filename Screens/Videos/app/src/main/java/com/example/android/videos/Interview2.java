...
public class Interview2 extends AppCompatActivity {
    ImageButton iButton;
    VideoView video;
    ...
    public void playVideo(View v)
    {
        ...
        Uri uri = Uri.parse("android.resource://com.example.android.videos/"+R.raw.interview2); // Uniform Resource Identifier - accepts a string of chars used to identify the resource
