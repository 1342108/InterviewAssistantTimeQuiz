...
public class BodyLanguage1 extends AppCompatActivity {
    ...
    public void playVideo(View v)
    {
        ...
        Uri uri = Uri.parse("android.resource://com.example.android.videos/"+R.raw.body_language1); // Uniform Resource Identifier - accepts a string of chars used to identify the resource
